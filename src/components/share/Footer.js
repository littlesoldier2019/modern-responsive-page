...
import { variables } from "../../assets/copy/variables.ts";
            ...
            <div className="col-sm-12 col-md-6 col-lg-4 my-3 my-md-5">
              <ul className="list-group list-group-flush my-0 my-md-5 d-flex align-items-end flex-column">
                ...
                <li className="list-group-item mb-4 py-1 text-center">
                  ...
                  <img
                    alt="kielo consultancy"
                    src="https://img.icons8.com/android/8/000000/right.png"
                  />
                </li>
                <li className="list-group-item mb-4 py-1 text-center">
                ...
                <li className="list-group-item text-center py-1 px-2">
                  <a href="https://www.facebook.com/kieloconsultancy/">
                    <img
                      className="facebook-icon"
                      alt="kielo consultancy"
                      src="https://img.icons8.com/material-rounded/18/000000/facebook-f--v2.png"
                    />
                  </a>
                </li>
              </ul>
