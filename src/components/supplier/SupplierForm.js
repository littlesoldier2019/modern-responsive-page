...
const SupplierForm = () => {
  ...
  const sendEmail = (templateId, templateParams) => {
    emailjs
      .send("gmail", templateId, templateParams, "user_UWBdejJ5naQLFcokey62a")
      .then((res) => {
  ...
  return (
    <div className="bg-light py-lg-5">
      <div className="container p-3 pd-5 bg-light">
        ...
        <p className="text-center mb-3 mb-md-5">
          Please complete the following form if you are interested to be our
          supplier partner.
        </p>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-row">
            <div className="form-group col-12 col-md-6">
              ...
              />
              {errors.productRange && (
                <p className="error-message">{errors.productRange.message}</p>
              )}
            </div>
            <div className="form-group col-12 col-md-6">
          ...
          <div className="form-group">
            ...
            />
            {errors.catalog && (
              <p className="error-message">{errors.catalog.message}</p>
            )}
          </div>
          <div className="form-group">
            <label htmlFor="factoryInfo">
              Other information about your manufactories
            </label>
            <textarea
              className="form-control"
              id="factoryInfo"
            ...
            ></textarea>
            {errors.factoryInfo && (
              <p className="error-message">{errors.factoryInfo.message}</p>
            )}
          </div>
          <Button text="submit" />
