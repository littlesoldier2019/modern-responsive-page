...
const SectionLeft = () => {
  return (
    <div className='container'>
        <div className="row">
            <div className="col-sm-12 col-md-6 d-flex justify-content-center align-items-center my-5 section section-item">
                <div>
                    <h2 className="mb-5 px-5">find the outcome for manufactuers</h2>
                    <p className='mb-5 px-5'>Born in a very hard time in matching demands in EU and supplying capacities in Vietnam . We know many factories, they face to difficult when there is a crisis time in the country. Bolck down everywhere, but workers can not end their need of rice. 
                    ...
                    <p className='mb-5 px-5'>Factories we chosen here is one qualified FDA (for US), CE for EU. And have official export liciense for the sold items. 
